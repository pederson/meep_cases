...
(define-param sx 40) ; size of cell in x direction (perp to dielectric strip)
...
(set! geometry
    (append
	   ...
	   (geometric-object-duplicates (vector3 0 (- 0 (+ sz1 sz2)) 0) 0 (- (/ Nseg 2) 2) 
			(make block (center 0 (- (/ sy 2) (/ sz2 2) sz1)) (size w sz1 infinity) (material (make dielectric (epsilon eps1)))))
		; dielectric 2
