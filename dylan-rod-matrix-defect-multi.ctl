...
(set! geometry
    (append
       ...
       (geometric-object-duplicates (vector3 0 rodspace 0) 0 (- (/ Nrows 2) 1) 
		...
		(geometric-object-duplicates (vector3 0 rodspace 0) 0 (- (/ Nrows 2) 2) 
			(make cylinder (center (* rodspace 5) (+ rodspace (/ rrod 2))) (radius rrod) (height infinity) (material (make dielectric (epsilon eps)))))
       ...
       (geometric-object-duplicates (vector3 0 rodspace 0) 0 (- (/ Nrows 2) 1) 
		...
		(geometric-object-duplicates (vector3 0 rodspace 0) 0 (- (/ Nrows 2) 2) 
			(make cylinder (center (* rodspace 7) (+ rodspace (/ rrod 2))) (radius rrod) (height infinity) (material (make dielectric (epsilon eps)))))
