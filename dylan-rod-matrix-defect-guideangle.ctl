...
(define-param wlen (* (sqrt 2) rodspace)) ; wavelength of the source

; The computational cell dimensions
(define-param sy (+ (* Nrows rodspace) (* rrod 1) )) ; size of cell in y dir
...
(set! geometry
    (append
       ...
       (geometric-object-duplicates (vector3 0 rodspace 0) 0 (- (/ Nrows 2) 1) 
		...
		(geometric-object-duplicates (vector3 0 rodspace 0) 0 (- (/ Nrows 2) 2) 
			(make cylinder (center (* rodspace 3) (+ rodspace (/ rrod 2))) (radius rrod) (height infinity) (material (make dielectric (epsilon eps)))))


		;/----------------- defect column up -----------------------------------
       (geometric-object-duplicates (vector3 0 rodspace 0) 0 (+ (/ Nrows 2) 0) 
			(make cylinder (center (* rodspace 4) (+ (- 0 (/ sy 2)) rrod)) (radius rrod) (height infinity) (material (make dielectric (epsilon eps)))))
		(geometric-object-duplicates (vector3 0 rodspace 0) 0 (- (/ Nrows 2) 3) 
			(make cylinder (center (* rodspace 4) (+ (* 2 rodspace) (/ rrod 2))) (radius rrod) (height infinity) (material (make dielectric (epsilon eps)))))
       ...
       (geometric-object-duplicates (vector3 0 rodspace 0) 0 (+ (/ Nrows 2) 1) 
		...
		;/----------------- defect column upupup --------------------------------
       (geometric-object-duplicates (vector3 0 rodspace 0) 0 (+ (/ Nrows 2) 2) 
			(make cylinder (center (* rodspace 6) (+ (- 0 (/ sy 2)) rrod)) (radius rrod) (height infinity) (material (make dielectric (epsilon eps)))))
		(geometric-object-duplicates (vector3 0 rodspace 0) 0 (- (/ Nrows 2) 5) 
			(make cylinder (center (* rodspace 6) (+ (* 4 rodspace) (/ rrod 2))) (radius rrod) (height infinity) (material (make dielectric (epsilon eps)))))
			
		;/----------------- defect column upupupup -----------------------------
       (geometric-object-duplicates (vector3 0 rodspace 0) 0 (+ (/ Nrows 2) 3) 
